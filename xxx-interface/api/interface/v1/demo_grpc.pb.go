...
const (
	Demo_ListPage_FullMethodName = "/api.interface.v1.Demo/ListPage"
)
...
func (c *demoClient) ListPage(ctx context.Context, in *RoleListRequest, opts ...grpc.CallOption) (*RoleListReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RoleListReply)
	err := c.cc.Invoke(ctx, Demo_ListPage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDemoServer) ListPage(context.Context, *RoleListRequest) (*RoleListReply, error) {
...
func _Demo_ListPage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RoleListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DemoServer).ListPage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Demo_ListPage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DemoServer).ListPage(ctx, req.(*RoleListRequest))
	}
...
var Demo_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.interface.v1.Demo",
	HandlerType: (*DemoServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ListPage",
			Handler:    _Demo_ListPage_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api/interface/v1/demo.proto",
}
