...
const OperationUserCheckPermission = "/api.helloworld.v1.User/CheckPermission"
...
const OperationUserVerifyToken = "/api.helloworld.v1.User/VerifyToken"
...
func RegisterUserHTTPServer(s *http.Server, srv UserHTTPServer) {
	r := s.Route("/")
	r.GET("/user/list", _User_ListPage2_HTTP_Handler(srv))
	...
	r.POST("/user/delete", _User_DeleteById1_HTTP_Handler(srv))
	r.POST("/user/checkPermission", _User_CheckPermission0_HTTP_Handler(srv))
	r.POST("/user/verifyToken", _User_VerifyToken0_HTTP_Handler(srv))
}
