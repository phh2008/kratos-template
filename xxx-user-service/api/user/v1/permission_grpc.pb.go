...
const (
	Permission_ListPage_FullMethodName = "/api.user.v1.Permission/ListPage"
	Permission_Add_FullMethodName      = "/api.user.v1.Permission/Add"
	Permission_Update_FullMethodName   = "/api.user.v1.Permission/Update"
)
...
func (c *permissionClient) ListPage(ctx context.Context, in *PermListRequest, opts ...grpc.CallOption) (*PermListReply, error) {
	...
	err := c.cc.Invoke(ctx, Permission_ListPage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var Permission_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/user/v1/permission.proto",
}
