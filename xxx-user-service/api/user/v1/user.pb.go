...
const file_api_user_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x16api/user/v1/user.proto\x12\vapi.user.v1\x1a\x1cgoogle/api/annotations.proto\"\xc1\x01\n" +
	...
	"\x04role\x18\x03 \x01(\tR\x04role2\xc8\x05\n" +
	"\x04User\x12X\n" +
	"\bListPage\x12\x1c.api.user.v1.UserListRequest\x1a\x1a.api.user.v1.UserListReply\"\x12\x82\xd3\xe4\x93\x02\f\x12\n" +
	"/user/list\x12f\n" +
	"\rCreateByEmail\x12\x1d.api.user.v1.UserEmailRequest\x1a\x16.api.user.v1.UserReply\"\x1e\x82\xd3\xe4\x93\x02\x18:\x01*\"\x13/user/createByEmail\x12c\n" +
	"\fLoginByEmail\x12\".api.user.v1.UserEmailLoginRequest\x1a\x17.api.user.v1.LoginReply\"\x16\x82\xd3\xe4\x93\x02\x10:\x01*\"\v/user/login\x12^\n" +
	"\n" +
	"AssignRole\x12\x1e.api.user.v1.AssignRoleRequest\x1a\x13.api.user.v1.UserOk\"\x1b\x82\xd3\xe4\x93\x02\x15:\x01*\"\x10/user/assignRole\x12Z\n" +
	"\n" +
	"DeleteById\x12\x1e.api.user.v1.UserDeleteRequest\x1a\x13.api.user.v1.UserOk\"\x17\x82\xd3\xe4\x93\x02\x11:\x01*\"\f/user/delete\x12m\n" +
	"\x0fCheckPermission\x12#.api.user.v1.CheckPermissionRequest\x1a\x13.api.user.v1.UserOk\" \x82\xd3\xe4\x93\x02\x1a:\x01*\"\x15/user/checkPermission\x12n\n" +
	"\vVerifyToken\x12#.api.user.v1.UserVerifyTokenRequest\x1a\x1c.api.user.v1.UserClaimsReply\"\x1c\x82\xd3\xe4\x93\x02\x16:\x01*\"\x11/user/verifyTokenB<\n" +
