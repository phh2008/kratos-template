...
const (
	Role_ListPage_FullMethodName         = "/api.user.v1.Role/ListPage"
	Role_Add_FullMethodName              = "/api.user.v1.Role/Add"
	Role_GetByCode_FullMethodName        = "/api.user.v1.Role/GetByCode"
	Role_AssignPermission_FullMethodName = "/api.user.v1.Role/AssignPermission"
	Role_DeleteById_FullMethodName       = "/api.user.v1.Role/DeleteById"
)
...
func (c *roleClient) ListPage(ctx context.Context, in *RoleListRequest, opts ...grpc.CallOption) (*RoleListReply, error) {
	...
	err := c.cc.Invoke(ctx, Role_ListPage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *roleClient) Add(ctx context.Context, in *RoleSaveRequest, opts ...grpc.CallOption) (*RoleReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RoleReply)
	err := c.cc.Invoke(ctx, Role_Add_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *roleClient) GetByCode(ctx context.Context, in *RoleCodeRequest, opts ...grpc.CallOption) (*RoleReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RoleReply)
	err := c.cc.Invoke(ctx, Role_GetByCode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *roleClient) AssignPermission(ctx context.Context, in *RoleAssignPermRequest, opts ...grpc.CallOption) (*RoleOk, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RoleOk)
	err := c.cc.Invoke(ctx, Role_AssignPermission_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var Role_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/user/v1/role.proto",
}
