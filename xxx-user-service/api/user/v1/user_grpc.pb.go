...
const (
	User_ListPage_FullMethodName        = "/api.user.v1.User/ListPage"
	User_CreateByEmail_FullMethodName   = "/api.user.v1.User/CreateByEmail"
	User_LoginByEmail_FullMethodName    = "/api.user.v1.User/LoginByEmail"
	User_AssignRole_FullMethodName      = "/api.user.v1.User/AssignRole"
	User_DeleteById_FullMethodName      = "/api.user.v1.User/DeleteById"
	User_CheckPermission_FullMethodName = "/api.user.v1.User/CheckPermission"
	User_VerifyToken_FullMethodName     = "/api.user.v1.User/VerifyToken"
)
...
type UserClient interface {
	...
	// 校验权限
	CheckPermission(ctx context.Context, in *CheckPermissionRequest, opts ...grpc.CallOption) (*UserOk, error)
	// 验证token
	VerifyToken(ctx context.Context, in *UserVerifyTokenRequest, opts ...grpc.CallOption) (*UserClaimsReply, error)
}
...
func (c *userClient) ListPage(ctx context.Context, in *UserListRequest, opts ...grpc.CallOption) (*UserListReply, error) {
	...
	err := c.cc.Invoke(ctx, User_ListPage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) CreateByEmail(ctx context.Context, in *UserEmailRequest, opts ...grpc.CallOption) (*UserReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserReply)
	err := c.cc.Invoke(ctx, User_CreateByEmail_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) CheckPermission(ctx context.Context, in *CheckPermissionRequest, opts ...grpc.CallOption) (*UserOk, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserOk)
...
func (c *userClient) VerifyToken(ctx context.Context, in *UserVerifyTokenRequest, opts ...grpc.CallOption) (*UserClaimsReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserClaimsReply)
...
func (UnimplementedUserServer) CheckPermission(context.Context, *CheckPermissionRequest) (*UserOk, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CheckPermission not implemented")
}
func (UnimplementedUserServer) VerifyToken(context.Context, *UserVerifyTokenRequest) (*UserClaimsReply, error) {
...
func _User_VerifyToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).VerifyToken(ctx, req.(*UserVerifyTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
