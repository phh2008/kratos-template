...
const OperationRoleAdd = "/api.user.v1.Role/Add"
const OperationRoleAssignPermission = "/api.user.v1.Role/AssignPermission"
const OperationRoleDeleteById = "/api.user.v1.Role/DeleteById"
const OperationRoleGetByCode = "/api.user.v1.Role/GetByCode"
const OperationRoleListPage = "/api.user.v1.Role/ListPage"
...
func RegisterRoleHTTPServer(s *http.Server, srv RoleHTTPServer) {
	r := s.Route("/")
	r.GET("/v1/role/list", _Role_ListPage1_HTTP_Handler(srv))
	r.POST("/v1/role/add", _Role_Add1_HTTP_Handler(srv))
	r.GET("/v1/role/code", _Role_GetByCode0_HTTP_Handler(srv))
	r.POST("/v1/role/assignPerm", _Role_AssignPermission0_HTTP_Handler(srv))
	r.POST("/v1/role/delete", _Role_DeleteById0_HTTP_Handler(srv))
}

func _Role_ListPage1_HTTP_Handler(srv RoleHTTPServer) func(ctx http.Context) error {
...
func _Role_Add1_HTTP_Handler(srv RoleHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
